...
public class SignUpActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup city spinner
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.city_array, android.R.layout.simple_spinner_item); // city_array is a placeholder, replace with your actual array resource
